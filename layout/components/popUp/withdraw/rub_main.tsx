...
export const RUBMain: FC = () => {
    ...
    const checkAmount = () => {
        ...
        if (store_withdraw.activePlatform === "card" && store_withdraw.amount < 1100 ||
            ...
            store_withdraw.activePlatform === "aifory" && store_withdraw.amount < 2050 ||
                    ...
                    <div className={styles.withdraw_wrap_right_data_wrap}>
                        ...
                        {store_withdraw.activePlatform === "СБП" && <div className={styles.withdraw_input_wrap}>
                            <input
                                ...
                                className={`${styles.withdraw_wrap_right_input_active} ${styles.withdraw_wrap_right_input} ${styles.withdraw_wrap_right_input_frst}`}/>
                            {fullNameError &&
                                <p className={styles.withdraw_wrap_right_amount_wrap_err}>{t("Enter your full name")}</p>}
                        </div>}
                        {store_withdraw.activePlatform === "СБП" && <div className={styles.withdraw_input_wrap}>
                            <input
                                type="text"
                                ...
                                className={`${styles.withdraw_wrap_right_input_active} ${styles.withdraw_wrap_right_input} ${styles.withdraw_wrap_right_input_frst}`}/>
                            {phoneNumberError &&
                                <p className={styles.withdraw_wrap_right_amount_wrap_err}>{t("Enter your full phone number")}</p>}
                        </div>}
                        {store_withdraw.activePlatform === "СБП" && <div className={styles.withdraw_input_wrap}>
                            <input
                                type="text"
                                ...
                                className={`${styles.withdraw_wrap_right_input_active} ${styles.withdraw_wrap_right_input} ${styles.withdraw_wrap_right_input_frst}`}/>
                            {dateError &&
                                <p className={styles.withdraw_wrap_right_amount_wrap_err}>{t("Enter the date of registration of the card")}</p>}
                        </div>}
                        {store_withdraw.activePlatform === "СБП" && <div className={styles.withdraw_input_wrap}>
                            <input
                                type="text"
                                ...
                                className={`${styles.withdraw_wrap_right_input_active} ${styles.withdraw_wrap_right_input} ${styles.withdraw_wrap_right_input_frst}`}/>
                            {bankError &&
                                <p className={styles.withdraw_wrap_right_amount_wrap_err}>{t("Enter your bank")}</p>}
                        </div>}
                    </div>
                </div>
